...
@section('body')
    <section id="thankyou" style="background-image: url('{{ asset('image/thankyoubanner.png') }}'); background-repeat: no-repeat; background-size: cover; background-position: center;">
        <div class="col">
            <img src="{{ asset('image/Thank You.png') }}" alt="">
